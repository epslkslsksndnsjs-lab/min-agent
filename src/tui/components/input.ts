...
export class Input implements Component, Focusable {
  ...
  handleInput(data: string): void {
    ...
    // Kitty CSI-u printable character (e.g. \x1b[97u for 'a'). Terminals with
    // Kitty protocol flag 1 (disambiguate) send CSI-u for all keys, including
    // plain printable characters. Decode before the control-char check since
    // CSI-u sequences contain \x1b which would be rejected.
  ...
  render(width: number): string[] {
    ...
    // Build line with fake cursor — insert cursor character at cursor position
